...
export default function ServiceForm() {
  return (
    <section className="sm:py-10 lg:py-20 sm:px-6 md:px-16 lg:px-20 bg-Darkbg text-white">
      <div className="md:flex md:flex-nowrap sm:flex-wrap  md:justify-between md:items-center bg-black p-6 sm:p-10 lg:p-14 gap-8">
        {/* Left Section */}
        <article className="sm:w-full md:w-1/2 lg:w-2/3 mb-8">
          ...
          <div className="mt-8">
            ...
            <p className="flex items-center mb-2 text-sm sm:text-base">
              <IoLocationOutline className="mr-2 text-lg" /> 123 Business
              Street, Suite 456, Your City
            </p>
